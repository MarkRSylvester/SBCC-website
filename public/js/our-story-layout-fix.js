document.addEventListener('DOMContentLoaded', function() {
  console.log('Applying layout fix to Our Story accordion content...');
  
  // Function to create a clean structure with rectangular layout
  function fixOurStoryLayout() {
    ...
    // Create a simplified single-column structure
    const newHTML = `
    ...
    console.log('Our Story accordion layout fixed');
  }
